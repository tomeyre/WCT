...
//            new GetChicargoCrime(context, bespokeSearch).execute("https://data.cityofchicago.org/resource/6zsd-86xi.json?$where=within_circle(location, " + latLng.getLatLng().latitude + ", " + latLng.getLatLng().longitude + ", 1000) and date between '" + dateUtil.getYear() + "-" + dateUtil.getMonth() + "-01T00:00:00' and '2017-02-01T00:00:00'");
//        } else if (currentAddress.getAddress().toLowerCase().contains("los angeles")) {
//            new GetLACrime(context, bespokeSearch).execute("https://data.lacity.org/resource/7fvc-faax.json?$where=within_circle(location_1, " + latLng.getLatLng().latitude + ", " + latLng.getLatLng().longitude + ", 1000) and date_occ between '" + dateUtil.getYear() + "-" + dateUtil.getMonth() + "-01T00:00:00' and '2017-02-01T00:00:00'");
